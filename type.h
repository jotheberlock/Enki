...
class Type
{
  public:
    ...
    virtual Value *generateFuncall(Codegen *, Funcall *, Value *, Value *, std::vector<Value *> &args)
    {
...
class FunctionType : public Type
{
  public:
    ...
    virtual Value *generateFuncall(Codegen *, Funcall *, Value *sl, Value *fp, std::vector<Value *> &args);
...
{
  public:
    ExternalFunctionType(CallingConvention *c, bool ia = false) : FunctionType(false)
    {
        convention = c;
    ...
    virtual Value *generateFuncall(Codegen *c, Funcall *f, Value *, Value *fp, std::vector<Value *> &args);
...
{
  public:
    GenericFunctionType() : FunctionType(false)
    {
    }

    ~GenericFunctionType();

    virtual Value *generateFuncall(Codegen *c, Funcall *f, Value *sl, Value *fp, std::vector<Value *> &args);
